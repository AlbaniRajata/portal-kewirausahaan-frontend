...
export default function DashboardJuriPage() {
  ...
  const [data, setData] = useState({ profile: null, penugasan: [] });
    ...
    return (
      <BodyLayout Sidebar={JuriNavbar}>
        <Box sx={{ position: "relative", minHeight: "60vh" }}>
          <LoadingScreen message="Memuat dashboard juri..." overlay minHeight="60vh" />
        </Box>
      </BodyLayout>
    );
  }
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", lg: "1fr 1fr" }, gap: 2.5, mb: 2.5 }}>
            ...
            >
              ...
              <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
                ...
                <Typography sx={{ fontSize: 12, color: "#7c3aed", fontWeight: 700 }}>Sedang Dinilai: {penugasan.filter((p) => p.status === 3).length}</Typography>
