    ...
    try {
      ...
      if (response.success) {
        ...
        await Swal.fire({
          ...
          text: response.message || "Gagal memuat daftar penugasan",
      ...
      await Swal.fire({
        ...
        text: "Gagal memuat daftar penugasan. Silahkan refresh halaman.",
        confirmButtonText: "OK",
      });
    } finally {
      setLoading(false);
      ...
      <PageTransition>
        <Box>
          <Box sx={{ mb: 4 }}>
            ...
            <Typography sx={{ fontSize: 14, color: "#777" }}>Kelola penugasan penilaian proposal</Typography>
          </Box>
