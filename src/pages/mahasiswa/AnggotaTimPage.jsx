              ...
              <Table>
                <TableHead>
                  <TableRow sx={{ backgroundColor: "#0D59F2" }}>
                    <TableCell sx={{ color: "#fff", fontWeight: 700 }}>Nama Lengkap</TableCell>
                    <TableCell sx={{ color: "#fff", fontWeight: 700 }}>NIM</TableCell>
                    <TableCell sx={{ color: "#fff", fontWeight: 700 }}>Peran</TableCell>
