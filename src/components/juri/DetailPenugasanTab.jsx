        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Box sx={{
            ...
            <Box>
              ...
              <Typography sx={{ fontSize: 14, color: "#374151" }}>{penugasan.catatan_juri}</Typography>
            </Box>
          </Box>
        </Box>
      )}
          ...
          <Box sx={{ display: "flex", gap: 2, justifyContent: "flex-end" }}>
            <Button
              ...
              sx={{
                ...
                border: `1.5px solid ${COLORS.error}`, color: COLORS.error,
      ...
      >
        ...
        <DialogContent dividers sx={{ px: 3, py: 3 }}>
          <Box sx={{
            ...
            <Box sx={{ width: 8, height: 8, mt: 0.5, borderRadius: "50%", background: COLORS.error, flexShrink: 0 }} />
            <Box>
              <Typography sx={{ fontSize: 12, color: COLORS.error, fontWeight: 700, mb: 0.3 }}>Proposal yang akan ditolak</Typography>
              <Typography sx={{ fontSize: 14, fontWeight: 600, color: "#1F2937" }}>{penugasan.judul}</Typography>
            </Box>
          </Box>
          <Typography sx={{ fontSize: 13, fontWeight: 600, mb: 0.8, color: "#374151" }}>
        ...
        <DialogActions sx={{ px: 3, py: 2.5, gap: 1 }}>
          ...
          <Button
            variant="contained" onClick={handleRejectConfirm}
            sx={{
              textTransform: "none", borderRadius: "12px", px: 3, py: 1,
